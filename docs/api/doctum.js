...
(function(root) {
    ...
    var searchIndex = [
        ...
        {"type":"Method","fromName":"Coole\\Config\\ConfigServiceProvider","fromLink":"Coole/Config/ConfigServiceProvider.html","link":"Coole/Config/ConfigServiceProvider.html#method_register","name":"Coole\\Config\\ConfigServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        ...
        {"type":"Method","fromName":"Coole\\Console\\ConsoleServiceProvider","fromLink":"Coole/Console/ConsoleServiceProvider.html","link":"Coole/Console/ConsoleServiceProvider.html#method_register","name":"Coole\\Console\\ConsoleServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        ...
        {"type":"Method","fromName":"Coole\\DB\\DBServiceProvider","fromLink":"Coole/DB/DBServiceProvider.html","link":"Coole/DB/DBServiceProvider.html#method_register","name":"Coole\\DB\\DBServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        ...
        {"type":"Method","fromName":"Coole\\DB\\Facade\\DB","fromLink":"Coole/DB/Facade/DB.html","link":"Coole/DB/Facade/DB.html#method_setDefaultConnection","name":"Coole\\DB\\Facade\\DB::setDefaultConnection","doc":""},
                                ...
                                {"type":"Method","fromName":"Coole\\ErrorHandler\\ErrorHandlerServiceProvider","fromLink":"Coole/ErrorHandler/ErrorHandlerServiceProvider.html","link":"Coole/ErrorHandler/ErrorHandlerServiceProvider.html#method_register","name":"Coole\\ErrorHandler\\ErrorHandlerServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        ...
        {"type":"Method","fromName":"Coole\\ErrorHandler\\ErrorHandlerServiceProvider","fromLink":"Coole/ErrorHandler/ErrorHandlerServiceProvider.html","link":"Coole/ErrorHandler/ErrorHandlerServiceProvider.html#method_boot","name":"Coole\\ErrorHandler\\ErrorHandlerServiceProvider::boot","doc":"<p>引导应用程序.</p>"},
                                ...
                                {"type":"Method","fromName":"Coole\\Event\\EventServiceProvider","fromLink":"Coole/Event/EventServiceProvider.html","link":"Coole/Event/EventServiceProvider.html#method_register","name":"Coole\\Event\\EventServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        {"type":"Method","fromName":"Coole\\Event\\EventServiceProvider","fromLink":"Coole/Event/EventServiceProvider.html","link":"Coole/Event/EventServiceProvider.html#method_afterRegister","name":"Coole\\Event\\EventServiceProvider::afterRegister","doc":"<p>注册服务之后.</p>"},
                                ...
                                {"type":"Method","fromName":"Coole\\Event\\ListenerInterface","fromLink":"Coole/Event/ListenerInterface.html","link":"Coole/Event/ListenerInterface.html#method_handle","name":"Coole\\Event\\ListenerInterface::handle","doc":"<p>事件处理.</p>"},
                                                ...
                                                {"type":"Class","fromName":"Coole\\Foundation\\Able","fromLink":"Coole/Foundation/Able.html","link":"Coole/Foundation/Able/AbstractServiceProvider.html","name":"Coole\\Foundation\\Able\\AbstractServiceProvider","doc":null},
        ...
        {"type":"Method","fromName":"Coole\\Foundation\\AppServiceProvider","fromLink":"Coole/Foundation/AppServiceProvider.html","link":"Coole/Foundation/AppServiceProvider.html#method_register","name":"Coole\\Foundation\\AppServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        ...
        {"type":"Method","fromName":"Coole\\HttpKernel\\Controller\\HasControllerAble","fromLink":"Coole/HttpKernel/Controller/HasControllerAble.html","link":"Coole/HttpKernel/Controller/HasControllerAble.html#method_setFinishHandler","name":"Coole\\HttpKernel\\Controller\\HasControllerAble::setFinishHandler","doc":"<p>设置一个 <code>KernelEvents::TERMINATE</code> 事件监听处理器.</p>"},
                                ...
                                {"type":"Method","fromName":"Coole\\HttpKernel\\HttpKernelServiceProvider","fromLink":"Coole/HttpKernel/HttpKernelServiceProvider.html","link":"Coole/HttpKernel/HttpKernelServiceProvider.html#method_register","name":"Coole\\HttpKernel\\HttpKernelServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
                                ...
                                {"type":"Method","fromName":"Coole\\Invoker\\InvokerServiceProvider","fromLink":"Coole/Invoker/InvokerServiceProvider.html","link":"Coole/Invoker/InvokerServiceProvider.html#method_register","name":"Coole\\Invoker\\InvokerServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        ...
        {"type":"Method","fromName":"Coole\\Log\\LogServiceProvider","fromLink":"Coole/Log/LogServiceProvider.html","link":"Coole/Log/LogServiceProvider.html#method_register","name":"Coole\\Log\\LogServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        ...
        {"type":"Method","fromName":"Coole\\Routing\\Router","fromLink":"Coole/Routing/Router.html","link":"Coole/Routing/Router.html#method___call","name":"Coole\\Routing\\Router::__call","doc":""},
                                ...
                                {"type":"Method","fromName":"Coole\\Routing\\RoutingServiceProvider","fromLink":"Coole/Routing/RoutingServiceProvider.html","link":"Coole/Routing/RoutingServiceProvider.html#method_register","name":"Coole\\Routing\\RoutingServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
        ...
        {"type":"Method","fromName":"Coole\\View\\ViewServiceProvider","fromLink":"Coole/View/ViewServiceProvider.html","link":"Coole/View/ViewServiceProvider.html#method_register","name":"Coole\\View\\ViewServiceProvider::register","doc":"<p>{@inheritdoc}</p>"},
